...
if ($result->num_rows > 0) {
  ...
  echo "<table>";
  echo "<thead><tr><th></th><th>Name</th><th>Course</th><th>Phone number</th><th>Section Roll</th><th>College ID</th><th>Academic Year</th></tr></thead>";
  echo "<tbody>";
  ...
  if(isset($_POST['delete'])) {
    ...
    if(empty($colID)) {
      ...
      $N = count($colID);
      for($i=0; $i < $N; $i++) {
        $sql = "DELETE FROM champ WHERE college_id='$colID[$i]'";
        $result = $conn->query($sql);
